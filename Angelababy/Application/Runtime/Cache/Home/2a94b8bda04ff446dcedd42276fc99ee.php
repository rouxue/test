  ...
  <div id="banner">
    <div id="slider">
      <ul class="clear" id="imgs">
        <!-- <li style="z-index:1;" id="pic1">
          <a href="#">
            <img src="/Angelababy/Public/images/57a06cdd3cdc392173.jpg">
          </a>
        </li>
        <li id="pic2">
          <a href="#">
            <img src="/Angelababy/Public/images/579b24c5b097198637.jpg">
          </a>
        </li>
        <li id="pic3">
          <a href="#">
            <img src="/Angelababy/Public/images/57b6a10c240e623159.jpg">
          </a>
        </li>
        <li id="pic4">
          <a href="#">
            <img src="/Angelababy/Public/images/57c95be1b14ae56292.jpg">
          </a>
        </li> -->
      </ul>
      <ul id="indexs">
        <!-- <li onclick="pic(this)" id="circle1"></li>
        <li onclick="pic(this)" id="circle2"></li>
        <li onclick="pic(this)" id="circle3"></li>
        <li onclick="pic(this)" id="circle4"></li> -->
      </ul>

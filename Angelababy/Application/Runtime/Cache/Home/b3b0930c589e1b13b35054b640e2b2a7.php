  ...
  <div id="section">
    <div>
      ...
      <div class="sec_middle" id='plist'>
        <ul>
          <!-- <li>
            <img src="/Angelababy/Public/images/57a9a8cf86cb727541.jpg!thumb220.jpg"/>
            <h4>气球恐龙绿帽子</h4>
            <h3>￥188</h3>
            <a href="#"><img src="/Angelababy/Public/images/pinkcar.png"/></a>
          </li> -->
          <?php if(is_array($re)): $i = 0; $__LIST__ = $re;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li>
              <img src="/Angelababy/Public/<?php echo ($data["pic"]); ?>"/>
              <h4><?php echo (mb_substr($data["pname"],0,15)); ?></h4>
              <h3>￥<?php echo ($data["price"]); ?></h3>
              <a href="<?php echo ($data["pid"]); ?>" class='addcart'><img src="/Angelababy/Public/images/pinkcar.png"/></a>
            </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <ol class="pager">
          <?php echo ($pageList); ?>
